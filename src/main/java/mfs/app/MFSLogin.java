...
public class MFSLogin extends JFrame {
	...
	public MFSLogin() {
		...
		minimizeLabel_1.setForeground(new Color(255, 255, 255));
		...
		MaximizeLabel_2.setForeground(new Color(255, 255, 255));
		...
		closeLabel_3.setForeground(new Color(255, 255, 255));
		...
		guestButton.setBackground(new Color(65, 105, 225));
		...
		registerButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				reg.setSize(new Dimension(445, 730));
				reg.setVisible(true);
			}
		});
		...
		loginButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// TODO: check if contain in database, if contain, check password, if all correct, show message, close window
				setUsername(usernameField.getText());
				try {
					if(engine.verifyUser(getUsername())) {
		...
		loginButton_1.setBackground(new Color(0, 191, 255));
		loginButtonHorizontalBox.add(loginButton_1);
		LoginPanel.setLayout(gl_LoginPanel);
		
		JLabel lblNewLabel = new JLabel("A quote...\r\n");
		...
		gl_freespacePanel.setHorizontalGroup(
			gl_freespacePanel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_freespacePanel.createSequentialGroup()
					.addGap(46)
		...
		gl_freespacePanel.setVerticalGroup(
			gl_freespacePanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_freespacePanel.createSequentialGroup()
					.addComponent(LoginPanel, GroupLayout.DEFAULT_SIZE, 567, Short.MAX_VALUE)
					.addGap(0))
				.addGroup(Alignment.TRAILING, gl_freespacePanel.createSequentialGroup()
					.addGap(209)
